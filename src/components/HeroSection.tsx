    ...
    <section className="relative overflow-hidden bg-gradient-hero py-16 md:py-24">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Tagline */}
          <p className="mb-8 max-w-2xl text-lg text-primary-foreground/90 md:text-xl animate-slide-up px-4" style={{ animationDelay: "0.1s" }}>
            Perkhidmatan Penyelenggaraan Kubur Profesional & Amanah
          </p>

          {/* Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-slide-up w-full max-w-sm px-4 sm:px-0" style={{ animationDelay: "0.15s" }}>
             <Button 
               size="xl" 
               className="bg-white text-primary hover:bg-gray-100 font-bold w-full sm:w-auto"
             ...
             <Button 
               size="xl" 
               variant="outline" 
               className="bg-primary-foreground/10 text-white border-primary-foreground/20 hover:bg-primary-foreground/20 w-full sm:w-auto"
